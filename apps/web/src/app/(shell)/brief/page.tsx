  ...
  return (
    <main className="flex flex-1 flex-col bg-matos-bg">
      <div className="border-b border-matos-soft px-[22px] py-4">
        <h1 className="text-base font-semibold tracking-tight">Company brief</h1>
        <p className="mt-1.5 max-w-xl text-xs text-matos-muted">Mission, offers, ICP, and voice — versioned and editable in later phases.</p>
      </div>
